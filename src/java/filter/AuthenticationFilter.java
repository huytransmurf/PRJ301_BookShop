 ...
 * @author admin
 */
@WebFilter(filterName = "AuthenticationFilter", urlPatterns = {"/views/client/pages/order/order.jsp", "/views/admin/*", "/views/client/pages/cart.jsp", "/Cart","/GetAllOrder","/Order","/OrderServlet","/OrderDetail","/ReviewServlet"})
