                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            <img
                                ...
                                src="${pageContext.request.contextPath}/views/admin/assets\svg\illustrations\create.svg"
                ...
                <a class="card card-hover-shadow mb-4" href="${pageContext.request.contextPath}/GetAllOrder">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <img
                                class="avatar avatar-xl mr-4"
                                src="${pageContext.request.contextPath}/views/admin/assets\svg\illustrations\choice.svg"
                                alt="Image Description"
                                />
                ...
                <a class="card card-hover-shadow" href="${pageContext.request.contextPath}/products">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <img
                                class="avatar avatar-xl mr-4"
                                src="${pageContext.request.contextPath}/views/admin/assets\svg\illustrations\presenting.svg"
                                alt="Image Description"
                                />
