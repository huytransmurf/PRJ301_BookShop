        ...
        <div class="row">
            <div class="col-sm-5 col-md-6 col-12 pb-4">
                <nav class="navbar navbar-light bg-light mb-4">
                    <form class="form-inline" method="GET" action="${pageContext.request.contextPath}/GetReviewByProductIdServlet">
                        <input class="form-control mr-sm-2 w-400" type="search" placeholder="Search by Product ID" aria-label="Search" name="id">
