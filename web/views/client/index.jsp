                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            ...
                            <a href="/PRJ301_BookShop/NewServlet" class="btn px-4 py-2 text-white rounded">Fruites</a>
                        </div>
                        <div class="carousel-item rounded">
                            <img src="img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                            <a href="/PRJ301_BookShop/NewServlet" class="btn px-4 py-2 text-white rounded">Vesitables</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <a href="/PRJ301_BookShop/NewServlet" class="h5">Organic Tomato</a>
